...
/**
 * Genere ou charge l'espace de travail 
 * ~/JavaMAS/agents : sources des agents
 * ~/JavaMAS/build : binaires des agents 
 * ~/JavaMAS/deploy : jar des agents
 * ~/JavaMAS/docs : docs des agents
 * ~/JavaMAS/tmp : repertoire temporaires
 *
